...
class SupportOccupantTypeTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        return (
            record.get("name"),
            record.get("occupant_control"),
            record.get("energy_behavior"),
            record.get("occupant_schedule_early_bird"),
            record.get("occupant_schedule_early_bird_fraction"),
            record.get("occupant_schedule_regular_worker"),
            record.get("occupant_schedule_regular_worker_fraction"),
            record.get("occupant_schedule_late_owl"),
            record.get("occupant_schedule_late_owl_fraction"),
            record.get("occupant_schedule_night_shift"),
            record.get("occupant_schedule_night_shift_fraction"),
        )
