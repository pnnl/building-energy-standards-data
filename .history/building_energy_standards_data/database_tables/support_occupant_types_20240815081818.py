...
INSERT_OCCUPANT_TYPE = """
    ...
    (name, occupant_control, energy_behavior,
     occupant_schedule_early_bird_fraction, occupant_schedule_early_bird_occupant_schedule, 
     occupant_schedule_regular_worker_fraction, occupant_schedule_regular_worker_occupant_schedule, 
     occupant_schedule_late_owl_fraction, occupant_schedule_late_owl_occupant_schedule, 
     occupant_schedule_night_shift_fraction, occupant_schedule_night_shift_occupant_schedule)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);
"""
...
class SupportOccupantTypeTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        ...
        return (
            ...
            getattr_either(
                "occupant_schedule_regular_worker_occupant_schedule", record
            ),
