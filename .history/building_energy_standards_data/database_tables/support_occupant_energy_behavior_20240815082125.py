...
class SupportEnergyBehaviorTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        ...
        return (
            ...
            getattr_either("Minimum_Input_Power_Fraction_for_Continuous_Dimming_Control", record),
            getattr_either("Minimum_Light_Output_Fraction_for_Continuous_Dimming_Control", record),
        )