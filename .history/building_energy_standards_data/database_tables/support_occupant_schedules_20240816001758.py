...
schedule_ratio NUMERIC NOT NULL,
...
class SupportScheduleTable(DBOperation):
    ...
    def _preprocess_record(self, record):
        ...
        return (
            ...
            getattr_either("schedule_category", record),
            getattr_either("schedule_ratio", record),
