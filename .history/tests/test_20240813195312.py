...
for t in ["2004", "2007", "2010", "2013", "2016", "2019"]:
    create_openstudio_standards_data_json_ashrae_90_1(
        conn=conn,
        version_90_1=t,
        osstd_repository_path=r"C:\Users\Yilin Jiang\Energy Technologies Dropbox\Yilin Jiang\OpenStudio\OS gem refactor\Occupant types\Scripts\Github-repos\openstudio-standards",
    )
conn.close()
