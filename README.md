...
The database covers data related to ASHRAE Standard 90.1-2004 through 2025, ASHRAE Standard 62.1-1999 through 2022, and the International Energy Conservation Code (IECC) 2006 through 2024. It also includes specific data tables for the Performance Rating Method of ASHRAE Standard 90.1 (Appendix G). The structure of the database is documented [here](https://github.com/pnnl/building-energy-standards-data/blob/develop/docs/Structure.md).
