...
echo "Step 6: push new branch to OSSTD github (currently updating exterior lighting requirements (**/*ext_ltg*.json) data only)"
...
git commit -m "data_update (ext_ltg_only) ${COMMIT_ID:0:7}"
