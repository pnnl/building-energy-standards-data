...
echo "Step 6: push new branch to OSSTD github (currently updating boiler (**/*heat_rejection*.json) data only)"
...
git commit -m "data_update (heat_rejection_only) ${COMMIT_ID:0:7}"
